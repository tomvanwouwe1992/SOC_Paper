...
subplot(2,3,1)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m1,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
title('m1 - Brachialis')
...
subplot(2,3,2)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m2,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
...
subplot(2,3,3)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m3,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
...
a_m4_shoulder = dM_coefficients(4,1);
b_m4_shoulder = dM_coefficients(4,2);
c_m4_shoulder = dM_coefficients(4,3);
a_m4_elbow = dM_coefficients(4,4);
b_m4_elbow = dM_coefficients(4,5);
c_m4_elbow = dM_coefficients(4,6);
...
subplot(2,3,4)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m4,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
title('m4 - posterior deltoid')
...
subplot(2,3,5)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m5,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
title('m5 - Biceps short')
...
% m6 - Triceps long (shoulder elbow extensor)
% Operating range 0.6 - 1.1
a_m6_shoulder = dM_coefficients(6,1);
b_m6_shoulder = dM_coefficients(6,2);
c_m6_shoulder = dM_coefficients(6,3);
a_m6_elbow = dM_coefficients(6,4);
b_m6_elbow = dM_coefficients(6,5);
c_m6_elbow = dM_coefficients(6,6);

l_m6_0_0 = l_Range_2DOF(a_m6_shoulder,b_m6_shoulder,c_m6_shoulder,a_m6_elbow,b_m6_elbow,c_m6_elbow,0,0);
l_m6_180_180 = l_Range_2DOF(a_m6_shoulder,b_m6_shoulder,c_m6_shoulder,a_m6_elbow,b_m6_elbow,c_m6_elbow,pi,pi);
l_m6_multiplier = (0.85-1.2)/(l_m6_0_0-l_m6_180_180);
l_m6_base = 0.85;

[theta_shoulder_grid,theta_elbow_grid] = meshgrid(theta_shoulder,theta_elbow);
l_m6 = l_Muscle_2DOF(a_m6_shoulder,b_m6_shoulder,c_m6_shoulder,a_m6_elbow,b_m6_elbow,c_m6_elbow,l_m6_multiplier,l_m6_base,theta_shoulder,theta_elbow);
subplot(2,3,6)
contour(180/pi*theta_shoulder_grid, 180/pi*theta_elbow_grid, l_m6,'ShowText','on');
xlabel('shoulder')
ylabel('elbow')
title('m6 - Triceps long')

LMT_coefficients = [l_m1_base l_m1_multiplier; ...
                    l_m2_base l_m2_multiplier; ...
                    l_m3_base l_m3_multiplier; ...
                    l_m4_base l_m4_multiplier; ...
                    l_m5_base l_m5_multiplier; ...
                    l_m6_base l_m6_multiplier];
% save('LMT_coefficients.mat','LMT_coefficients');
