function functions = generateFunctions_OCP_4muscles_FF_FB(auxdata)
import casadi.*
...
dX_MX = forwardMusculoskeletalDynamics_monoarticular_motorNoise(X_MX,u_MX,zeros(2,1),wM_MX,auxdata); 
