function [result,succes] = OCP_4muscles_FF_FB_final_DCversion(target,forceField,wM_std,wPq_std,wPqdot_std,guessName)
%% SECTION TITLE
% DESCRIPTIVE TEXT
...
nStates = 8; auxdata.nStates = nStates; % #states (4 muscle states + 2 positions + 2 velocities)
