function functions = generateFunctions_OCP_4muscles_FF_FB_OldModel(auxdata)
import casadi.*
...
EE_MX = [EndEffectorPos(X_MX(5:6),auxdata); EndEffectorVel(X_MX(5:6),X_MX(7:8),auxdata)]; % End-effector kinematics computed from joint kinematics 
K_MX = MX.sym('K_MX',4,4);        % Feedback gains
...
dX_MX = forwardMusculoskeletalDynamics_monoarticular_motorNoise_OM(X_MX,u_MX,zeros(2,1),wM_MX,auxdata); 
