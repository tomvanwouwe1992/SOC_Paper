function [err] = implicitDynamics_Rotation(a_base,a,qA,qAdot,qP,qPdot,K,u,wM,wPqdotdot,wPq,wPqdot,wVq,wVqdot,auxdata)
...
e_vest = K(3:4,:)*([qV; qVdot] + [wVq;wVqdot]);

e = e_prop + e_vest + a_base;
...
qAdotdot = (m*g*l*sin(qA+qP) + M_E - (m*l^2+I)*wPqdotdot)/(m*l^2+I);
